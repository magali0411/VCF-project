...
def verif_opening(filepath) :
    ...
    def compteur_sec() :
        ...
        # Récursivité pour un compteur infini
        incremente()
...
def filtre() :
    ...
    def val() :
        ...
        try : 
            ...
            return showerror(main, message = "Wrong DP value")
        ...
        try :
            ...
            return showerror(main, message = "Wrong data value")
        #Desactivation de la séléction
        ...
        try :
            ...
            return showerror(main, message = "Wrong genotype value")
        #Desactivation de la séléction
